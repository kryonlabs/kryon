...
static const NodeType node_types[] = {
    {"Background", "Background", "Display", "Control", "Fill", NodeTypeFlagInsertable | NodeTypeFlagSelectable},
    {"Text", "Text", "Display", "Control", "Label", MOVABLE_TEXT},
    {"Paragraph", "Paragraph", "Display", "Control", "Rich text", NodeTypeFlagSelectable},
    {"Box", "Box", "Display", "Control", "Shape", INSERT_EDITABLE},
    {"Line", "Line", "Display", "Control", "Stroke", INSERT_EDITABLE},
    {"Bevel", "Bevel", "Display", "Control", "Relief", EDITABLE},
    {"Icon", "Icon", "Display", "Control", "Icon", EDITABLE},
    {"Image", "Image", "Display", "Control", "Image", INSERT_EDITABLE},

    {"Card", "Card", "Input", "Control", "Surface action", INSERT_EDITABLE},
    {"Button", "Button", "Input", "Control", "Action", INSERT_EDITABLE},
    {"Link", "Link", "Input", "Control", "Link", EDITABLE},
    {"TextField", "Text Field", "Input", "Control", "Input", INSERT_EDITABLE},
    {"Dropdown", "Dropdown", "Input", "Control", "Selection", INSERT_EDITABLE},
    {"Slider", "Slider", "Input", "Control", "Value", INSERT_EDITABLE},
    {"Toggle", "Toggle", "Input", "Control", "On/off", INSERT_EDITABLE},
    {"Checkbox", "Checkbox", "Input", "Control", "Boolean", INSERT_EDITABLE},
    {"Radio", "Radio", "Input", "Control", "Choice", EDITABLE},
    {"Progress", "Progress", "Input", "Control", "Progress", EDITABLE},
    {"Spinbox", "Spinbox", "Input", "Control", "Number", EDITABLE},
    {"ColorPicker", "Color Picker", "Input", "Control", "Color", EDITABLE},
    {"SegmentedControl", "Segmented Control", "Input", "Control", "Segments", EDITABLE},

    {"Group", "Group", "Layout", "Control", "Container", INSERT_EDITABLE},
    {"Separator", "Separator", "Layout", "Control", "Divider", EDITABLE},
    {"Fieldset", "Fieldset", "Layout", "Control", "Frame", EDITABLE},
    {"PanedView", "Paned View", "Layout", "Control", "Split panes", EDITABLE},
    {"Collapsible", "Collapsible", "Layout", "Control", "Section", EDITABLE},

    {"ListBox", "List Box", "Collections", "Control", "List", EDITABLE},
    {"TreeView", "Tree View", "Collections", "Control", "Tree", EDITABLE},
    {"TableView", "Table View", "Collections", "Control", "Table", EDITABLE},
    {"TextArea", "Text Area", "Collections", "Control", "Text area", EDITABLE},
    {"CanvasGrid", "Canvas Grid", "Collections", "Control", "Grid", EDITABLE},

    {"Menu", "Menu", "Navigation", "Control", "Menu", EDITABLE},
    {"NavigationBar", "Navigation Bar", "Navigation", "Control", "Tabs", EDITABLE},
    {"Toolbar", "Toolbar", "Navigation", "Control", "Tools", EDITABLE},
    {"TabBar", "Tab Bar", "Navigation", "Control", "Tabs", EDITABLE},
    {"TitleBar", "Title Bar", "Navigation", "Control", "Title", EDITABLE},

    {"Focus", "Focus", "Overlays", "Control", "Focus", EDITABLE},
    {"Modal", "Modal", "Overlays", "Control", "Dialog", EDITABLE},
