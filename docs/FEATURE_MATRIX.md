...
`parse_widget_statement` (`cmd/kir/kir_parse.c`) recognizes 159 widget names.
...
ListItem Main Mark Meter Nav Navigation EmbeddedObject OrderedList OptionGroup OptGroup Option
Output Param Pre Quote Rp Rt Ruby RubyParenthesis RubyText Samp Sample Search Select Slot Small Source Strong Sub Subscript Summary Sup Superscript Table
