...
int main(int argc, char **argv)
{
    ...
    assert(has_result && result == 0 && texts == 0 && fills == 0);
    assert(BundleInstanceRun(instance, &result, &has_result));
    assert(has_result && result == 42 && texts == 3 && fills == 2);
