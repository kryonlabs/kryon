...
static const FlintThemeCatalogColors catalog_dark[FLINT_THEME_COUNT] = {
    [FLINT_THEME_SKY] = {{0x18,0x28,0x38,0xFF}, {0xA0,0xC0,0xE0,0xFF}, {0x50,0x80,0xB0,0xFF}, {0x30,0x50,0x70,0xFF}, {0x40,0x70,0x90,0xFF}, {0x18,0x28,0x38,0xFF}, {0x60,0xA0,0xD0,0xFF}},
    [FLINT_THEME_OCEAN] = {{0x10,0x25,0x40,0xFF}, {0x80,0xB0,0xD0,0xFF}, {0x30,0x60,0x90,0xFF}, {0x20,0x40,0x60,0xFF}, {0x30,0x55,0x75,0xFF}, {0x10,0x25,0x40,0xFF}, {0x50,0x90,0xC0,0xFF}},
    [FLINT_THEME_FOREST] = {{0x15,0x30,0x20,0xFF}, {0xA0,0xC0,0xA0,0xFF}, {0x35,0x65,0x45,0xFF}, {0x25,0x45,0x30,0xFF}, {0x30,0x55,0x40,0xFF}, {0x15,0x30,0x20,0xFF}, {0x50,0x80,0x60,0xFF}},
    [FLINT_THEME_SUNSET] = {{0x30,0x18,0x10,0xFF}, {0xD0,0xA0,0x80,0xFF}, {0x80,0x40,0x28,0xFF}, {0x50,0x28,0x18,0xFF}, {0x60,0x35,0x25,0xFF}, {0x30,0x18,0x10,0xFF}, {0xC0,0x50,0x30,0xFF}},
    [FLINT_THEME_LAVENDER] = {{0x20,0x15,0x30,0xFF}, {0xB0,0x90,0xC0,0xFF}, {0x50,0x35,0x70,0xFF}, {0x35,0x20,0x50,0xFF}, {0x45,0x30,0x65,0xFF}, {0x20,0x15,0x30,0xFF}, {0x90,0x60,0xB0,0xFF}},
    [FLINT_THEME_CHERRY] = {{0x30,0x15,0x20,0xFF}, {0xC0,0x80,0x90,0xFF}, {0x70,0x30,0x45,0xFF}, {0x45,0x20,0x28,0xFF}, {0x55,0x30,0x38,0xFF}, {0x30,0x15,0x20,0xFF}, {0xB0,0x40,0x60,0xFF}}
};
