...
| `TextArea` | `Collections` | Text area | `src/ui/text_input.zi`, `src/ui/text_input_props.zi`, `src/ui/text_area_widget.zi`, `src/ui/syntax.zi` | checked Ziran | Caller owned text and state, visual wrapping, pointer selection, vertical/page navigation, scrolling, edit intents, KSS, Ziran/C/Make syntax coloring, composition underlines, and clipped paint are checked. IME event handling, clipboard commands, and native host integration remain. |
...
| `TextArea` | checked Ziran | Caller owned text; wrapped rows, pointer selection, page navigation, scroll, KSS and syntax paint, composition underlines, and multiline edit intents. IME event handling, clipboard commands, and native host integration remain. |
...
| `TextArea` | checked Ziran | `text_area_widget.zi` and `syntax.zi` own visual rows, retained input, selection, scroll, KSS and syntax paint, composition underlines, and multiline edit intents; applications own text and focus state. IME event handling, clipboard commands, and native host integration remain. |
