 ...
 */
 ...
 const KryonPropertyGroup kryon_element_specific_properties[] = {
     ...
     {"position", (const char*[]){NULL}, 0x0613, KRYON_TYPE_HINT_STRING},
     {"tabSpacing", (const char*[]){NULL}, 0x0614, KRYON_TYPE_HINT_INTEGER},
     {"indicatorColor", (const char*[]){NULL}, 0x0615, KRYON_TYPE_HINT_COLOR},
     {"indicatorThickness", (const char*[]){NULL}, 0x0616, KRYON_TYPE_HINT_INTEGER},
     {"activeBackgroundColor", (const char*[]){NULL}, 0x0617, KRYON_TYPE_HINT_COLOR},
     {"activeTextColor", (const char*[]){NULL}, 0x0618, KRYON_TYPE_HINT_COLOR},
