...
lowers to the declared capacity in executable JS and has focused syntax-runner
coverage; element-size expressions and computed capacities remain open. Broader
