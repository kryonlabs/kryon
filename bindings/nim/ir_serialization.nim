...
proc ir_write_json_v2_with_manifest_file*(root: ptr IRComponent; manifest: ptr IRReactiveManifest; filename: cstring): bool {.importc, cdecl, header: "ir_serialization.h".}
