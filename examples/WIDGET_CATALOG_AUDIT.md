...
| Collections & editors | ListBox, TreeView, TableView, ListBox multi-select and drag/drop. Ctrl adds selections; Shift selects a range. Drag/drop copies the actual payload. TreeView displays the caller-supplied tree. |
