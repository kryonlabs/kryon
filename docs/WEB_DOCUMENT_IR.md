...
text justification, line breaking, hanging punctuation, text spacing,
text emphasis, ruby/text-combine, and text box controls,
...
list-style, counters, quotes, marker controls, table layout controls, and
fragmentation controls,
flex flow/grow/shrink/basis/order,
