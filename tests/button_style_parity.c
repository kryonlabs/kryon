...
int main(void)
{
    const int enum_pairs[][2] = {
        {StyleBackground, FieldBackground},
        {StyleForeground, FieldForeground},
        {StyleBorder, FieldBorder},
        {StyleFocus, FieldFocus},
        {StyleRadius, FieldRadius},
        {StyleBorderWidth, FieldBorderWidth},
        {StyleOpacity, FieldOpacity},
        {StylePaddingX, FieldPaddingX},
        {StylePaddingY, FieldPaddingY},
        {StyleGap, FieldGap},
        {StyleFontSize, FieldFontSize},
        {StyleIconSize, FieldIconSize},
        {StyleContentOffset, FieldContentOffset},
        {StyleBackgroundEnd, FieldBackgroundEnd},
        {StyleMaterial, FieldMaterial},
        {ControlSizeMedium, PolicySizeMedium},
        {ControlSizeSmall, PolicySizeSmall},
        {ControlSizeLarge, PolicySizeLarge},
        {ButtonToneNeutral, PolicyToneNeutral},
        {ButtonToneAccent, PolicyToneAccent},
        {ButtonToneDanger, PolicyToneDanger},
        {ButtonToneSuccess, PolicyToneSuccess},
        {ButtonToneWarning, PolicyToneWarning},
        {ButtonEmphasisFilled, PolicyEmphasisFilled},
        {ButtonEmphasisSoft, PolicyEmphasisSoft},
        {ButtonEmphasisOutline, PolicyEmphasisOutline},
        {ButtonEmphasisGhost, PolicyEmphasisGhost},
        {ButtonEmphasisLink, PolicyEmphasisLink},
        {ButtonStateAuto, PolicyStateAuto},
        {ButtonStateNormal, PolicyStateNormal},
        {ButtonStateHover, PolicyStateHover},
        {ButtonStatePressed, PolicyStatePressed},
        {ButtonStateFocus, PolicyStateFocus},
        {ButtonStateDisabled, PolicyStateDisabled},
        {ButtonStateLoading, PolicyStateLoading},
        {ButtonStateSelected, PolicyStateSelected},
    };
