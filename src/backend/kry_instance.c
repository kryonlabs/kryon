...
void InitWindow(int width, int height, const char *title)
{
    ...
    /* Smooth shape edges and tear-free presentation are part of Kryon's UI
     * surface, so request multisampling and synchronized buffer swaps instead
     * of requiring every application to know the backend's pre-window
     * configuration. Raylib treats these as hints and falls back cleanly when
     * a platform cannot provide them. This must happen before context setup. */
