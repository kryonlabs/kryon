/* Generated by k2c from runtime/selectable_props.kry. */
#ifndef K_RUNTIME_SELECTABLE_PROPS_H
#define K_RUNTIME_SELECTABLE_PROPS_H
...
typedef struct SelectableProps {
    Rectangle bounds;
    int32_t id;
    const char* label;
    int32_t* selected;
