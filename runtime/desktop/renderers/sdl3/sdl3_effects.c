/**
 * SDL3 Effects - SDL3-Specific Visual Effects
 *
 * This file implements SDL3 visual effects including:
 * - Color utilities and conversions
 * - Gradient rendering (linear, radial, conic)
 * - Rounded rectangle rendering with scanline optimization
 * - Background rendering (solid colors and gradients)
 * - Text effects (shadows, fading)
 */
...
extern int wrap_text_into_lines(const char* text, float max_width, TTF_Font* font,
