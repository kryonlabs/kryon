...
const ThemeMeta themes[THEME_COUNT] = {
    ...
    [THEME_AERO] = {"Aero", "aero_light", "aero_dark"}
};
...
static const ThemeCatalogColors catalog_light[THEME_COUNT] = {
    ...
    [THEME_AERO] = {{0xDD,0xE9,0xF5,0xFF}, {0xEB,0xF2,0xFA,0xFF}, {0x17,0x24,0x36,0xFF}, {0x3A,0x77,0xC2,0xFF}, {0xC9,0xE0,0xF4,0xFF}, {0x9C,0xC6,0xEA,0xFF}, {0xDD,0xE9,0xF5,0xFF}, {0x0A,0x63,0xC9,0xFF}}
};
...
static const ThemeCatalogColors catalog_dark[THEME_COUNT] = {
    ...
    [THEME_AERO] = {{0x10,0x18,0x21,0xFF}, {0x1A,0x27,0x35,0xFF}, {0xC9,0xD8,0xE8,0xFF}, {0x4F,0x94,0xDC,0xFF}, {0x24,0x38,0x4E,0xFF}, {0x31,0x48,0x5F,0xFF}, {0xC9,0xD8,0xE8,0xFF}, {0x66,0xA8,0xE8,0xFF}}
};
...
theme_locale_key(ThemeId theme)
{
    ...
    case THEME_AERO: return "theme_aero";
    default: return NULL;
    }
}
