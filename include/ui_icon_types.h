...
typedef enum {
    ...
    UI_ICON_TYPE_MUSIC,
    UI_ICON_TYPE_MUTE,
    UI_ICON_TYPE_NAV_HABITS,
    UI_ICON_TYPE_NAV_LIST,
    UI_ICON_TYPE_NAV_PRACTICE,
    UI_ICON_TYPE_NAV_SETTINGS,
    UI_ICON_TYPE_PAUSE,
    ...
    UI_ICON_TYPE_PLATFORMS_APPIMAGE,
    UI_ICON_TYPE_PLATFORMS_BROWSER,
    UI_ICON_TYPE_PLATFORMS_CHROMEWEBSTORE,
    UI_ICON_TYPE_PLATFORMS_DEBIAN,
    UI_ICON_TYPE_PLATFORMS_DISCORD,
    UI_ICON_TYPE_PLATFORMS_DROID,
    UI_ICON_TYPE_PLATFORMS_ESP32,
    UI_ICON_TYPE_PLATFORMS_FDROID,
    UI_ICON_TYPE_PLATFORMS_FEDORA,
    UI_ICON_TYPE_PLATFORMS_FLATPAK,
    ...
    UI_ICON_TYPE_PROJ_KRYON,
    UI_ICON_TYPE_PROJ_WAO,
    UI_ICON_TYPE_RETURN,
    UI_ICON_TYPE_RIGHT,
    UI_ICON_TYPE_ROCKET,
    ...
    UI_ICON_TYPE_TRASH,
    UI_ICON_TYPE_VENUS,
    UI_ICON_TYPE_WARNING,
    UI_ICON_TYPE_WEEKLY,
    UI_ICON_TYPE_WORKBOOK_CLEAR_FORMATTING,
    UI_ICON_TYPE_WORKBOOK_FILL_COLOR,
    UI_ICON_TYPE_WORKBOOK_TEXT_COLOR,
    UI_ICON_TYPE_WRENCH,
    UI_ICON_TYPE_X,

    UI_ICON_TYPE_COUNT = 124
} UIIconType;
