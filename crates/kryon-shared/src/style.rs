...
pub struct ComputedStyle {
    ...
    pub text_alignment: crate::elements::TextAlignment,
...
impl StyleComputer {
    ...
    fn apply_property_to_computed_style(
        ...
        match property_enum {
            ...
            crate::PropertyId::TextAlignment => {
                if let Some(s) = prop_value.as_string() {
                    computed_style.text_alignment = match s {
                        "start" => crate::elements::TextAlignment::Start,
                        "center" => crate::elements::TextAlignment::Center,
                        "end" => crate::elements::TextAlignment::End,
            ...
            crate::PropertyId::Width | crate::PropertyId::Height => {
    ...
    pub fn compute_with_state(&self, element_id: ElementId, state: crate::InteractionState) -> ComputedStyle {
        ...
        if element.text_alignment != crate::elements::TextAlignment::Start { computed_style.text_alignment = element.text_alignment; }
