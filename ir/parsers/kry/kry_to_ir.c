...
// Property handler aliases (kry_to_ir_properties.c)
#define get_component_type(name) kry_get_component_type(name)
#define apply_property(ctx, comp, name, val) kry_apply_property(ctx, comp, name, val)
#define resolve_value_as_string(ctx, val, unres) kry_resolve_value_as_string(ctx, val, unres)
#define get_value_as_bool(val, out) kry_get_value_as_bool(val, out)
#define parse_alignment(align) kry_parse_alignment(align)

// Function conversion aliases (kry_to_ir_functions.c)
#define convert_child_statements(ctx, child, func, out) kry_convert_child_statements(ctx, child, func, out)
#define convert_function_stmt(ctx, stmt, func) kry_convert_function_stmt(ctx, stmt, func)
#define convert_return_stmt(node) kry_convert_return_stmt(node)
#define convert_module_return(ctx, node) kry_convert_module_return(ctx, node)
#define convert_function_decl(ctx, node, scope) kry_convert_function_decl(ctx, node, scope)
