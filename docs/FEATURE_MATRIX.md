...
`parse_widget_statement` (`cmd/kir/kir_parse.c`) recognizes 137 widget names.
...
Output Pre Quote Samp Sample Select Small Source Strong Sub Subscript Summary Sup Superscript Table
