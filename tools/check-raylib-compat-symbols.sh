...
frontend_sources="${4:-src/backend/kry_surface_math.c} src/backend/kry_screenshot.c src/backend/kry_event_wait.c src/backend/kry_instance.c src/backend/kry_image.c src/platform/open_uri.c"
