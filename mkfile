...
CPPFLAGS=-I$SHIM -I$ROOT/include -I$ROOT/src -I$ROOT/src/ui -I$GEN -I$GEN/generated -I$GEN/generated/src -I$GEN/generated/runtime -I$ROOT/vendor/utf8proc -DUTF8PROC_STATIC -I$ROOT/vendor/monocypher/src/optional -I$RAYEXT \
