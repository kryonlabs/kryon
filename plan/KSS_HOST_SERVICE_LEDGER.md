...
| C active style resolver | `src/ui/style_sheet.c` | host service | Hold active style-pack pointer and route render-time queries to generated cascade. | `runtime/style_sheet.kry`. | `make style-sheet-policy-test style-pack-source-test style-release-table-repro-test style-release-table-emitter-test` |
