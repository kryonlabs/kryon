...
static const ThemeCatalogColors catalog_light[THEME_COUNT] = {
    ...
    [THEME_SWEET] = {{0xEE,0xEE,0xEE,0xFF}, {0xEC,0xEC,0xEC,0xFF}, {0x31,0x36,0x3D,0xFF}, {0xC5,0x0E,0xD2,0xFF}, {0xD5,0xD5,0xD5,0xFF}, {0xC5,0x0E,0xD2,0xFF}, {0x31,0x36,0x3D,0xFF}, {0xE3,0x23,0xF0,0xFF}}
};
...
static const ThemeCatalogColors catalog_dark[THEME_COUNT] = {
    ...
    [THEME_SWEET] = {{0x16,0x19,0x25,0xFF}, {0x18,0x1B,0x28,0xFF}, {0xC3,0xC7,0xD1,0xFF}, {0xC5,0x0E,0xD2,0xFF}, {0x20,0x24,0x35,0xFF}, {0xC5,0x0E,0xD2,0xFF}, {0xC3,0xC7,0xD1,0xFF}, {0xE3,0x23,0xF0,0xFF}}
};
