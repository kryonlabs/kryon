...
For actual runtime output across all button tones, emphases, and states, use
the [button gallery](../examples/button_gallery.md). The image above is a design
illustration; gallery captures are generated by `Button(ButtonProps)`.
