...
- Execute scroll_content and the remaining composed_popup cases in JS with
  ...
  editing, dropdown overlay capture, dropdown keyboard/flipped-popup selection, rotated table hit geometry, custom table-cell layout/disabled editing, and basic tree opening; composed_popup has
