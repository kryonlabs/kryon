...
if rg -n '\b(BeginButton|BeginCard|BeginCanvas|CanvasScope|BeginDisabled|DisabledScope|BeginScroll|ScrollScope|BeginTableCell|TableCellScope|EndCanvas|CanvasEndScope|EndDisabled|DisabledEndScope|EndScroll|ScrollEndScope|EndTableCell|TableCellEndScope|PopupEndScope|InvisibleButton)\b' "$work/out" >/tmp/kryon-k2js-lowered.$$ 2>/dev/null; then
