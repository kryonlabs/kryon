/* Generated by k2c from runtime/fieldset_props.kry. */
#ifndef K_RUNTIME_FIELDSET_PROPS_H
#define K_RUNTIME_FIELDSET_PROPS_H
...
typedef struct FieldsetProps {
    Rectangle bounds;
    int32_t class_name;
    const char* title;
} FieldsetProps;

#endif /* K_RUNTIME_FIELDSET_PROPS_H */
