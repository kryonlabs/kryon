...
# pkg-config checks below; tui and null link with no raylib at all.
...
KRYON_ALL_SRCS := $(filter-out $(KRYON_DIR)/src/backend/tui_%.c,$(KRYON_ALL_SRCS))
endif
...
CFLAGS = -Wall -Wextra -std=c99 -Os -fPIE $(KRYON_NATIVE_FEATURE_DEFS) -ffunction-sections -fdata-sections -DSUPPORT_FILEFORMAT_JPG=1 -DMINIZ_NO_ZLIB_COMPATIBLE_NAMES -DUI_EMBEDDED_ONLY=1 $(KRYON_RUNTIME_ASSET_CFLAGS)
