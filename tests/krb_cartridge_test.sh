...
App :: () #ui {
    Screen root: {
        ...
        Text((TextProps){.bounds={Scale(4), Scale(4), 0, 0}, .text="hi", .wrap=TextWrapNone})
        Image((ImageProps){"tiles/tile.png", "", (Rectangle){Scale(8), Scale(20), Scale(16), Scale(16)}, (Rectangle){0,0,0,0}, (Vector2){0,0}, 0.0f, ImageFitContain})
