...
$(BUILD_DIR)/libkryon_host.a: src/backend/frame_pacing_host.c src/backend/bevel_host.c include/kryon_portable_host.h $(ZIRAN_INCLUDE)/ziran_host.h Makefile
	mkdir -p $(BUILD_DIR)
	$(CC) -std=c11 -Iinclude -I$(ZIRAN_INCLUDE) -c src/backend/frame_pacing_host.c -o $(BUILD_DIR)/frame_pacing_host.o
	$(CC) -std=c11 -Iinclude -I$(ZIRAN_INCLUDE) -c src/backend/bevel_host.c -o $(BUILD_DIR)/bevel_host.o
	rm -f $@
	$(AR) rcs $@ $(BUILD_DIR)/frame_pacing_host.o $(BUILD_DIR)/bevel_host.o
