...
export interface Runtime {
  ...
  QueueMouseMove(x: number, y: number): void;
  QueueMouseWheel(delta: number): void;
  QueueMouseButtonDown(button: number, x: number, y: number): void;
  QueueMouseButtonUp(button: number, x: number, y: number): void;
...
export interface WebDOMRelations {
  ...
  imageMap: WebDOMObject | null;
  mappedImages: WebDOMObject[];
...
export interface WebNodeRelations {
  ...
  imageMap: WebDocumentNode | null;
  mappedImages: WebDocumentNode[];
...
export function Opacity(color: unknown, opacity: unknown): number;
export function GradientColor(top: unknown, bottom: unknown, position: unknown): number;
export function InteractionValue(normal: unknown, hover: unknown, press: unknown, focus: unknown, hoverAmount: unknown, pressAmount: unknown, focusAmount: unknown): number;
export function InteractionColor(normal: unknown, hover: unknown, press: unknown, focus: unknown, hoverAmount: unknown, pressAmount: unknown, focusAmount: unknown): number;
export function FillState(fields: unknown, start: unknown, end: unknown): Record<string, unknown>;
export function FillTransition(normal: Record<string, unknown>, hover: Record<string, unknown>, press: Record<string, unknown>, focus: Record<string, unknown>, h: unknown, p: unknown, f: unknown): Record<string, unknown>;
export function LoadingRing(width: unknown, height: unknown, iconSize: unknown, elapsedMs: unknown, color: unknown, ambient: unknown): Record<string, unknown>;
export function ResolveFlags(state: unknown, disabled: unknown, loading: unknown, selected: unknown): Record<string, unknown>;
export function ResolveState(explicitState: unknown, disabled: unknown, loading: unknown, pressed: unknown, hovered: unknown, focused: unknown, selected: unknown): number;
export function ResolveInteraction(explicitState: unknown, disabled: unknown, loading: unknown, pressed: unknown, hovered: unknown, focused: unknown, selected: unknown): Record<string, unknown>;
export function CanActivate(disabled: unknown, loading: unknown): boolean;
export function ContentBounds(width: unknown, height: unknown, paddingX: unknown, paddingY: unknown): Record<string, unknown>;
export function InsetBounds(bounds: Record<string, unknown>, paddingX: unknown, paddingY: unknown, scale: unknown): Record<string, unknown>;
export function CenterChild(declared: Record<string, unknown>, measured: Record<string, unknown>, content: Record<string, unknown>): Record<string, unknown>;
export function FitHeight(requested: unknown, minimum: unknown, content: unknown, padding: unknown): number;
export function MaterialLayer(...args: unknown[]): Record<string, unknown>;
export function ApplyFillStates(layer: Record<string, unknown>, states: Record<string, unknown>, opacity: unknown): Record<string, unknown>;
export function FillGradient(layer: Record<string, unknown>, enabled: unknown, start: unknown, end: unknown, opacity: unknown): Record<string, unknown>;
...
export function AcceleratorPressed(rt: Runtime | null | undefined, accelerator: unknown): number;
...
export function GetMouseDelta(): { x: number; y: number };
export function GetMouseWheelMove(): number;
export function GetMouseWheelMoveV(): { x: number; y: number };
...
export const KeyEscape: number;
export const KeySpace: number;
export const KeyEnter: number;
export const KeyTab: number;
export const KeyBackspace: number;
export const KeyDelete: number;
export const KeyRight: number;
export const KeyLeft: number;
export const KeyDown: number;
export const KeyUp: number;
export const KeyPageUp: number;
export const KeyPageDown: number;
export const KeyHome: number;
export const KeyEnd: number;
export const KeyLeftShift: number;
export const KeyLeftControl: number;
export const KeyLeftAlt: number;
export const KeyRightShift: number;
export const KeyRightControl: number;
export const KeyRightAlt: number;
export const KeyA: number;
export const KeyC: number;
export const KeyV: number;
export const KeyX: number;
...
export function Area(...args: unknown[]): unknown;
export function Background(...args: unknown[]): unknown;
export function Base(...args: unknown[]): unknown;
...
export function BidirectionalIsolate(...args: unknown[]): unknown;
export function BidirectionalOverride(...args: unknown[]): unknown;
...
export function ImageMap(...args: unknown[]): unknown;
...
export function LineBreak(...args: unknown[]): unknown;
...
export function Meta(...args: unknown[]): unknown;
...
export function EmbeddedObject(...args: unknown[]): unknown;
...
export function Param(...args: unknown[]): unknown;
...
export function RubyParenthesis(...args: unknown[]): unknown;
export function RubyText(...args: unknown[]): unknown;
...
export function WordBreakOpportunity(...args: unknown[]): unknown;
