...
// ============================================================================
// Internal Aliases for Lexer Functions
// ============================================================================

// These aliases allow existing code to use the shorter names
#define peek(p) kry_peek(p)
#define advance(p) kry_advance(p)
#define match(p, c) kry_match(p, c)
#define skip_whitespace(p) kry_skip_whitespace(p)

// Token parsing aliases (from kry_tokens.h)
#define parse_identifier(p) kry_parse_identifier(p)
#define parse_string(p) kry_parse_string(p)
#define parse_number(p) kry_parse_number(p)
