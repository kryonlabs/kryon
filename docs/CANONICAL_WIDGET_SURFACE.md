...
1. Finish C geometry-to-`.kry` migration:
  ...
  `runtime/radio.kry`. Continue by reducing raw
  ...
  default state-layer alpha, elevation shadow policy, and ripple paint policy
  now route through `runtime/style.kry`.
