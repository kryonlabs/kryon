...
kss-matched-test: $(GENERATED_SRC_DIR)/runtime/style_sheet.c $(GENERATED_SRC_DIR)/runtime/style_sheet.h $(GENERATED_SRC_DIR)/runtime/style.c $(GENERATED_SRC_DIR)/runtime/surface.c $(GENERATED_SRC_DIR)/runtime/kss_parser.c $(GENERATED_SRC_DIR)/runtime/kss_formatter.c $(GENERATED_SRC_DIR)/runtime/kss_parser.h src/ui/kss_parser.c src/ui/kss_parser.h include/ui_style_sheet.h tests/fixtures/kss/matched.kss tests/fixtures/kss/matched_module.kss tests/fixtures/kss/css-values.kss tests/fixtures/kss/selector-predicates.tsv
