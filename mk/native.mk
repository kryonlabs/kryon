...
$(TARGET): $(SRC) $(KRYON_SRCS) $(FONT_FILES) $(EMBEDDED_ASSETS_C) $(KRYON_BACKEND_LIBS) $(CORE_A) $(KRYON_NATIVE_DEPS) | $(NATIVE_BIN_DIR)
	$(CC) $(CFLAGS) \
		$(APP_INCLUDE) \
		$(KRYON_INCLUDE) \
		$(CORE_INCLUDE) \
		...
		$(if $(filter raylib,$(KRYON_BACKEND)),-DKRYON_BACKEND_RAYLIB=1) \
...
build-linux-arch: $(KRYON_RAYLIB_BACKEND_RENAME_HEADER) $(SRC) $(KRYON_NATIVE_DEPS)
