...
main(void)
{
    ...
    assert((int)paint.thumb_bounds.y == 38);
    assert((int)paint.thumb_bounds.width == 6);
    assert((int)paint.thumb_bounds.height == 28);
    assert(paint.track_span == 72);
    assert(paint.scroll_per_pixel > 2.22f && paint.scroll_per_pixel < 2.23f);
    assert(ScrollDragOffsetFor(66.0f, 20.0f, 8.0f, 160, paint) == 84);
    ...
    assert(ScrollThumbDragDeltaOffsetFor(40, 10, 160, paint) == 62);
