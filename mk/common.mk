...
KRYON_DAOCHI_SRCS = $(wildcard $(KRYON_DIR)/src/ksync/*.c)
KRYON_DAOCHI_CFLAGS = $(if $(filter 1,$(KRYON_WITH_DAOCHI)),-DKRYON_WITH_DAOCHI=1 -DKRYON_WITH_KSYNC=1,-DKRYON_WITH_DAOCHI=0 -DKRYON_WITH_KSYNC=0)
KRYON_WEB_DAOCHI_CFLAGS = $(if $(filter 1,$(KRYON_WITH_DAOCHI)),-DHAS_LIBOQS=1 -DKRYON_HAS_LIBOQS=1 -I$(KRYON_WEB_LIBOQS_BUILD_DIR)/include,)
KRYON_WEB_DAOCHI_DEPS = $(if $(filter 1,$(KRYON_WITH_DAOCHI)),$(KRYON_WEB_LIBOQS_A),)
KRYON_WEB_DAOCHI_LIBS = $(if $(filter 1,$(KRYON_WITH_DAOCHI)),$(KRYON_WEB_LIBOQS_A),)
...
KRYON_ALL_SRCS := $(filter-out $(KRYON_DAOCHI_SRCS),$(KRYON_ALL_SRCS))
endif
...
CFLAGS = -Wall -Wextra -std=c99 -Os -fPIE $(KRYON_NATIVE_FEATURE_DEFS) -ffunction-sections -fdata-sections -DSUPPORT_FILEFORMAT_JPG=1 -DMINIZ_NO_ZLIB_COMPATIBLE_NAMES -DUI_EMBEDDED_ONLY=1 $(KRYON_DAOCHI_CFLAGS) $(KRYON_RUNTIME_ASSET_CFLAGS)
