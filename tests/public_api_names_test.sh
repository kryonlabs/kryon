...
manual_widget_props_matches="$(
    rg -n 'typedef struct \{[^}]*\} (CheckboxProps|SelectableProps|ToggleProps|SeparatorProps|RadioProps|ProgressProps|SpinboxProps|FieldsetProps|ScrollProps|PlotProps|ColorPickerProps|PanedViewProps|CollapsibleProps|DragProps|SliderProps|InputProps|ToastProps|TextProps|PopupProps)|type (CheckboxProps|SelectableProps|ToggleProps|SeparatorProps|RadioProps|ProgressProps|SpinboxProps|FieldsetProps|ScrollProps|PlotProps|ColorPickerProps|PanedViewProps|CollapsibleProps|DragProps|SliderProps|InputProps|ToastProps|TextProps|PopupProps) struct' \
        include/ui_tree.h \
        include/ui_tk.h \
        go/kryon/runtime.go \
        --glob '!vendor/**' \
