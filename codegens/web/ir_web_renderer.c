...
"// ============================================================================\n"
"// For Loop Runtime Expansion\n"
"// ============================================================================\n\n"
"// For loop template cache\n"
"const kryonForTemplates = new Map();\n"
"let kryonCloneIdCounter = 10000;\n\n"
"/**\n"
" * Expand For loop container with data array\n"
" * @param {string} containerId - ID of the For loop container element\n"
" * @param {Array} data - Array of data items to render\n"
" * @param {Object} parentContext - Parent context for nested For loops\n"
" */\n"
"function kryonExpandFor(containerId, data, parentContext) {\n"
"    const container = document.getElementById(containerId);\n"
"    if (!container) {\n"
"        console.warn('[Kryon For] Container not found:', containerId);\n"
"        return;\n"
"    }\n\n"
...
"    if (!kryonForTemplates.has(containerId)) {\n"
"        const template = container.firstElementChild;\n"
"        if (!template) {\n"
"            console.warn('[Kryon For] No template child in:', containerId);\n"
"            return;\n"
"        }\n"
"        kryonForTemplates.set(containerId, template.cloneNode(true));\n"
"    }\n\n"
"    const template = kryonForTemplates.get(containerId);\n"
"    container.innerHTML = '';\n\n"
"    if (!Array.isArray(data)) {\n"
"        console.warn('[Kryon For] Data is not an array:', data);\n"
"        return;\n"
"    }\n\n"
...
"    });\n\n"
"    console.log('[Kryon For] Expanded', containerId, 'with', data.length, 'items');\n"
"}\n\n"
"/**\n"
...
"        // Skip nested For containers - they'll handle their own IDs\n"
"        if (!child.classList.contains('kryon-for')) {\n"
...
"    return date > today;\n"
"}\n\n"
"// Expose For expansion to window/Lua\n"
"window.kryonExpandFor = kryonExpandFor;\n\n"
"// ============================================================================\n"
"// Smart Refresh for Non-For Containers\n"
"// ============================================================================\n\n"
"/**\n"
" * Smart refresh that works with any container structure\n"
" * - For For containers: clone template approach\n"
...
"        return;\n"
"    }\n\n"
"    const isFor = container.classList.contains('kryon-for');\n\n"
"    if (isFor) {\n"
"        kryonExpandFor(containerId, data, context);\n"
"    } else {\n"
"        kryonRefreshGrid(container, data, context);\n"
"    }\n"
"}\n\n"
"/**\n"
" * Update a grid of elements in-place (for non-For containers)\n"
...
"// ============================================================================\n"
"// Smart For Diffing (Phase 5)\n"
"// ============================================================================\n\n"
"// Cache for tracking For data by container ID\n"
"const kryonForDataCache = new Map();\n\n"
"/**\n"
" * Smart update For container with diffing\n"
" * Only updates changed elements instead of full re-render\n"
" * @param {string} containerId - For container ID\n"
" * @param {Array} newData - New data array\n"
" * @param {Object} parentContext - Parent context\n"
" */\n"
"function kryonSmartUpdateFor(containerId, newData, parentContext) {\n"
"    const container = document.getElementById(containerId);\n"
"    if (!container) return;\n\n"
"    const oldData = kryonForDataCache.get(containerId) || [];\n"
"    const template = kryonForTemplates.get(containerId);\n"
"    const itemName = container.dataset.itemName || 'item';\n"
"    const indexName = container.dataset.indexName || 'index';\n\n"
...
"    }\n\n"
"    // Update cache\n"
"    kryonForDataCache.set(containerId, [...newData]);\n"
"    console.log('[Kryon For] Smart updated', containerId, ':', oldLen, '->', newLen);\n"
"}\n\n"
"/**\n"
" * Deep equality check for For item diffing\n"
" */\n"
...
"window.kryonSmartUpdateFor = kryonSmartUpdateFor;\n\n"
"// ============================================================================\n"
