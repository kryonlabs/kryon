...
web_lowered_builder_matches="$(
    rg -n '\b(export function (BeginButton|BeginCanvas|BeginCard|BeginDisabled|DisabledScope|BeginScrollContainer|EndCanvas|EndDisabled|DisabledEndScope|EndScroll|BottomNav|ClearBackground)|"(BeginButton|BeginCanvas|BeginCard|BeginDisabled|DisabledScope|BeginScrollContainer|EndCanvas|EndDisabled|DisabledEndScope|EndScroll|InvisibleButton|BottomNav|ClearBackground)")\b' \
...
go_lowered_scope_exports="$(
    rg -n '^func (BeginDisabled|EndDisabled|DisabledScope|DisabledEndScope|PopupScope|PopupEndScope|BeginScroll|EndScroll|BeginTableCell|EndTableCell|BeginCanvas|EndCanvas)\(' \
        go/kryon/api.go \
        --glob '!vendor/**' \
        --glob '!build/**' || true
)"
...
lowered_doc_matches="$(
    rg -n '\b(BeginButton|BeginDisabled|EndDisabled|DisabledScope|DisabledEndScope|BeginScroll|EndScroll|BeginTableCell|EndTableCell|BeginCanvas|EndCanvas|PopupScope|PopupEndScope)\b' \
...
lowered_kry_source_matches="$(
    rg -n '\b(BeginButton|BeginCard|BeginDisabled|EndDisabled|DisabledScope|DisabledEndScope|BeginScroll|EndScroll|BeginTableCell|EndTableCell|BeginCanvas|EndCanvas|PopupScope|PopupEndScope|ClosePopup)\s*\(' \
