...
function webNodeFromWidget(item, index) {
  ...
  const node = {
    ...
    onBeforeInput: metaStringOrProp(meta, "onBeforeInput", args,
      ["on_before_input", "onBeforeInput", "beforeinput"]),
    ...
    onDragStart: metaStringOrProp(meta, "onDragStart", args, ["on_drag_start", "onDragStart", "dragstart"]),
    onDragEnd: metaStringOrProp(meta, "onDragEnd", args, ["on_drag_end", "onDragEnd", "dragend"]),
    onDragOver: metaStringOrProp(meta, "onDragOver", args, ["on_drag_over", "onDragOver", "dragover"]),
