...
const ThemeMeta themes[THEME_COUNT] = {
    ...
    [THEME_PLAN9] = {"Plan9", "plan9_light", "plan9_dark"},
    [THEME_XFCE] = {"Xfce", "xfce_light", "xfce_dark"},
    [THEME_SWEET] = {"Sweet", "sweet_light", "sweet_dark"}
};
...
static const ThemeCatalogColors catalog_light[THEME_COUNT] = {
    ...
    [THEME_PLAN9] = {{0xFF,0xFF,0xEA,0xFF}, {0xEF,0xEF,0xD2,0xFF}, {0x00,0x00,0x00,0xFF}, {0x6C,0x7E,0xC8,0xFF}, {0xDD,0xDD,0xC7,0xFF}, {0xC9,0xD1,0xFF,0xFF}, {0x00,0x00,0x00,0xFF}, {0x00,0x00,0xAA,0xFF}},
    [THEME_XFCE] = {{0xF3,0xF5,0xFA,0xFF}, {0xE7,0xEB,0xF4,0xFF}, {0x22,0x25,0x32,0xFF}, {0x9C,0x2E,0xB8,0xFF}, {0xC9,0x13,0xD4,0xFF}, {0xDD,0x44,0xE7,0xFF}, {0x22,0x25,0x32,0xFF}, {0x00,0x7F,0xA8,0xFF}},
    [THEME_SWEET] = {{0xF7,0xF3,0xFA,0xFF}, {0xEB,0xE4,0xF2,0xFF}, {0x25,0x22,0x2F,0xFF}, {0xC8,0x21,0xD1,0xFF}, {0xE6,0xBF,0xF1,0xFF}, {0xD7,0x8D,0xE8,0xFF}, {0x25,0x22,0x2F,0xFF}, {0x00,0x91,0xC7,0xFF}}
};
...
static const ThemeCatalogColors catalog_dark[THEME_COUNT] = {
    ...
    [THEME_PLAN9] = {{0x1B,0x1B,0x16,0xFF}, {0x2B,0x2B,0x23,0xFF}, {0xF4,0xF4,0xD8,0xFF}, {0x8A,0x96,0xD8,0xFF}, {0x3A,0x3A,0x30,0xFF}, {0x4A,0x4A,0x3D,0xFF}, {0xF4,0xF4,0xD8,0xFF}, {0xA8,0xB4,0xFF,0xFF}},
    [THEME_XFCE] = {{0x13,0x17,0x22,0xFF}, {0x1B,0x20,0x2E,0xFF}, {0xD4,0xD7,0xE1,0xFF}, {0xA7,0x33,0xC3,0xFF}, {0xC6,0x1B,0xD8,0xFF}, {0xE2,0x47,0xEF,0xFF}, {0xD4,0xD7,0xE1,0xFF}, {0x58,0xC7,0xE0,0xFF}},
    [THEME_SWEET] = {{0x13,0x10,0x1A,0xFF}, {0x1F,0x1A,0x29,0xFF}, {0xEF,0xE9,0xF7,0xFF}, {0xD0,0x24,0xD8,0xFF}, {0x5A,0x36,0x6D,0xFF}, {0x78,0x3F,0x8A,0xFF}, {0xEF,0xE9,0xF7,0xFF}, {0x33,0xD6,0xF2,0xFF}}
};
...
theme_locale_key(ThemeId theme)
{
    ...
    case THEME_PLAN9: return "theme_plan9";
    case THEME_XFCE: return "theme_xfce";
    case THEME_SWEET: return "theme_sweet";
    default: return NULL;
    }
}
