...
3. Finish text editing policy migration:
   ...
   context-menu command decision policy in `.kry`; remaining native work is
   buffer mutation, IME/composition, selection ownership/painting, and the
   final decision about how much of that can become reusable `.kry` policy.
