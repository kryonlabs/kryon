...
|---------|-----------|-------------|
| `Button` | `0x10` | Interactive button element |
| `Input` | `0x11` | User input field |
| `Link` | `0x12` | Clickable link element |
...
| Element | Hex Value | Description |
|---------|-----------|-------------|
| `Select` | `0x30` | Dropdown/combobox element |
| `Slider` | `0x31` | Range slider control |
| `ProgressBar` | `0x32` | Progress indicator |
| `Checkbox` | `0x33` | Checkbox control |
| `RadioGroup` | `0x34` | Radio button group |
| `Toggle` | `0x35` | Switch/toggle control |
| `DatePicker` | `0x36` | Date input control |
| `FilePicker` | `0x37` | File upload control |
...
| `List` | `0x41` | Ordered/unordered list |
| `ListItem` | `0x42` | List item element |
...
| Element | Hex Value | Description |
|---------|-----------|-------------|
| `Table` | `0x50` | Table container |
| `TableRow` | `0x51` | Table row |
| `TableCell` | `0x52` | Table cell |
| `TableHeader` | `0x53` | Table header cell |
