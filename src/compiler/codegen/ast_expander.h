...
/**
 * @brief Expand @const_if directive by evaluating at compile time
 * @param codegen Code generator context
 * @param const_if Const_if conditional node
 * @param ast_root Root of AST for constant lookups
 * @return true on success
 */
bool kryon_expand_const_if(KryonCodeGenerator *codegen,
                           const KryonASTNode *const_if,
                           const KryonASTNode *ast_root);
