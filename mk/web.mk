...
WEB_CFLAGS = -Wall -Wextra -std=gnu99 -Os -DPLATFORM_WEB -DGRAPHICS_API_OPENGL_ES2 -D_DEFAULT_SOURCE -DSUPPORT_MODULE_RAUDIO=1 -DSUPPORT_FILEFORMAT_JPG=1 -DSUPPORT_FILEFORMAT_OGG=1 -DSUPPORT_FILEFORMAT_MP3=1 -DKRYON_EMBEDDED_ONLY=1 $(KRYON_SYNC_CFLAGS) $(KRYON_WEB_SYNC_CFLAGS)
...
$(WEB_RAYLIB_BUILD_DIR)/%.o: $(RAYLIB_DIR)/%.c $(KRYON_RAYLIB_BACKEND_RENAME_HEADER) | $(WEB_RAYLIB_BUILD_DIR)
	$(WEB_CC) \
		-c $< \
		-o $@ \
		$(KRYON_RAYLIB_BACKEND_RENAME_CFLAG) \
		-Wall \
		-D_GNU_SOURCE \
		-DPLATFORM_WEB \
...
$(WEB_WORK_TARGET): $(BUILD_MAKEFILES) $(SRC) $(WEB_KRYON_SRCS) $(CORE_SRCS) $(WEB_SHELL) $(WEB_BACKEND_LIBS) $(KRYON_WEB_SYNC_DEPS) $(WEB_PUBLIC_FILES) | $(WEB_BUILD_DIR)
	$(WEB_CC) $(WEB_CFLAGS) \
		$(APP_INCLUDE) \
		$(KRYON_INCLUDE) \
		$(CORE_INCLUDE) \
